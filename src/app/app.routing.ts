...
export const appRoutes: Route[] = [
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: '/apps/gift-manage'},
    ...
    // Landing routes
    {
        ...
        children   : [
            /*{path: 'home', loadChildren: () => import('app/modules/landing/home/home.module').then(m => m.SumupRandomModule)},*/
            {path: 'sumup', loadChildren: () => import('app/modules/landing/sumup/sumup.module').then(m => m.SumupModule)},
            {path: 'random', canActivate: [AuthGuard], loadChildren: () => import('app/modules/landing/random/sumup-random.module').then(m => m.SumupRandomModule)},
        ]
    },
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            // Apps
            {path: 'apps', children: [
                {path: 'gift-manage', loadChildren: () => import('app/modules/admin/apps/gift-manage/gift-manage.module').then(m => m.GiftManageModule)},
                {path: 'employee-manage', loadChildren: () => import('app/modules/admin/apps/employee-manage/employee-manage.module').then(m => m.EmployeeManageModule)},
